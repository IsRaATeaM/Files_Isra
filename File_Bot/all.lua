...
if database:get(bot_id.."mokok7:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"*✯︙انتظر 7 دقائق من فضلك من فضلك\n✯︙ثم اعد المحاوله بعدها*")
end
database:setex(bot_id..'mokok7:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
